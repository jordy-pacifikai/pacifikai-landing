        ...
        <>
          <form onSubmit={handleSubmit} noValidate className="flex gap-2">
            ...
            <input
              ...
              required
              className="flex-1 min-w-0 min-h-[40px] rounded-lg border border-white/10 bg-bg px-3 py-2 text-sm text-text placeholder:text-text-dim outline-none focus:border-accent focus:ring-2 focus:ring-accent/25 transition"
            />
            <button
              type="submit"
              ...
              <ul className="space-y-1">
                {section.links.map((link) => (
                  <li key={link.href}>
                    <Link
                      href={link.href}
                      className="inline-block py-1 text-sm text-text-secondary hover:text-text transition-colors duration-200"
                    >
                      {link.label}
                    </Link>
                  </li>
                ...
                {section.title === "Légal" && (
                  <li>
                    <a
                      ...
                      className="inline-block py-1 text-[13px] text-accent hover:underline underline-offset-4 break-all"
                    >
