              ...
              <div className="relative bg-bg-card border border-border rounded-2xl p-8">
                ...
                <div className="flex items-center justify-between mt-8">
                  ...
                  <button
                    ...
                    onClick={goNext}
                    disabled={!canProceed}
                    className="inline-flex items-center gap-2 bg-accent text-bg font-semibold text-sm px-6 py-2.5 rounded-lg disabled:opacity-40 disabled:cursor-not-allowed hover:shadow-[0_0_24px_rgba(249,112,102,0.4)] hover:-translate-y-0.5 transition-all duration-300"
                  >
                ...
                {!submitted ? (
                  <>
                    ...
                    >
                      ...
                      <button
                        type="submit"
                        className="w-full mt-1 bg-accent text-bg font-bold py-3 rounded-xl hover:shadow-[0_0_24px_rgba(249,112,102,0.4)] hover:-translate-y-0.5 transition-all duration-300"
                      >
