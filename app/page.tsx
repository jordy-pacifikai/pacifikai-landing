...
import SiteAbonnementSection from "@/components/ui/SiteAbonnementSection";
...
const FAQ_SCHEMA = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Avec PACIFIK'AI, votre site web professionnel est disponible en abonnement à 4 900 XPF/mois, sans engagement et sans frais de mise en place. Tout est inclus : design, hébergement, nom de domaine, maintenance, sécurité et support. Paiement annuel : 49 000 XPF/an, soit 2 mois offerts.",
      },
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Absolument. Votre site web professionnel démarre à 4 900 XPF/mois (abonnement sans engagement) et nos solutions IA s'adaptent à la taille de votre entreprise. Le digital n'est plus réservé aux grandes entreprises — c'est un levier de compétitivité pour les PME polynésiennes.",
      },
    },
    {
      "@type": "Question",
