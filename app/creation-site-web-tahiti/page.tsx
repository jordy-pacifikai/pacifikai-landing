...
export const metadata: Metadata = {
  title: "Création de Site Web à Tahiti | PACIFIK'AI — Site Pro dès 4 900 XPF/mois",
  description:
    "Création de site web à Tahiti par PACIFIK'AI. Site internet professionnel en abonnement : 4 900 XPF/mois, sans engagement, 0 frais de mise en place. Hébergement, domaine, maintenance et SEO local inclus en Polynésie française.",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "Faire un site web à Tahiti avec PACIFIK'AI. Site internet professionnel en abonnement à 4 900 XPF/mois, sans engagement : design sur mesure, SEO local, hébergement et domaine inclus pour la Polynésie française.",
...
const SITE_TYPES = [
  {
    ...
    icon: "🏢",
    price: "4 900 XPF/mois, sans engagement",
  },
  {
...
const STATS = [
  ...
  { value: "1-2 sem", label: "pour être en ligne" },
  { value: "100%", label: "responsive mobile" },
  { value: "4 900", label: "XPF/mois, sans engagement" },
];
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Chez PACIFIK'AI, un site web professionnel à Tahiti se prend en abonnement : 4 900 XPF/mois, sans engagement et 0 frais de mise en place (soit environ 163 XPF/jour). Tout est inclus : design sur mesure, développement, hébergement et SSL, nom de domaine .pf ou .com, maintenance, mises à jour, sauvegardes, SEO local et support. En paiement annuel : 49 000 XPF/an, soit 2 mois offerts. Les sites e-commerce (boutique en ligne, paiement, stocks) font l'objet d'un devis dédié.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Chez PACIFIK'AI, un site vitrine est en ligne en 1 à 2 semaines. Un site e-commerce prend entre 2 et 4 semaines selon la complexité. Les landing pages sont généralement prêtes en quelques jours.",
      },
    },
    {
      "@type": "Question",
      ...
      <main className="pt-32 pb-20">
        ...
        <section className="max-w-5xl mx-auto px-6 mb-20">
          ...
          <p className="text-text-secondary text-lg leading-relaxed max-w-3xl mb-8">
            ...
            Google. Votre site vitrine professionnel en abonnement : 4 900 XPF/mois, sans
            engagement, 0 frais de mise en place — tout est inclus.
          </p>
        ...
        <section className="max-w-5xl mx-auto px-6 mb-20">
          <div className="glass rounded-2xl p-8 md:p-12 text-center">
            <h2 className="font-display text-[clamp(1.5rem,4vw,2.5rem)] font-bold mb-4">
              🔥 Votre site web professionnel à 4 900 XPF/mois
            </h2>
            <p className="text-text-secondary text-base leading-relaxed max-w-2xl mx-auto mb-6">
              Un site internet professionnel à Tahiti pour le prix d&apos;un café par jour
              (≈ 163 XPF/jour) — sans engagement et 0 frais de mise en place. Design sur
              mesure, responsive mobile, hébergement et SSL, nom de domaine .pf ou .com,
              maintenance, mises à jour, SEO local et support : tout est inclus. En annuel,
              49 000 XPF/an, soit 2 mois offerts.{" "}
        ...
        <section className="max-w-5xl mx-auto px-6 mb-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {[
              ...
              { label: "Hébergement inclus", icon: "☁️" },
              { label: "Certificat SSL (HTTPS)", icon: "🔒" },
              { label: "SEO local Google", icon: "🔍" },
              { label: "Maintenance & mises à jour", icon: "🔧" },
              { label: "Sécurité & sauvegardes", icon: "🛡️" },
              { label: "Modifications de contenu incluses", icon: "✍️" },
              { label: "Nom de domaine .pf ou .com inclus", icon: "🌐" },
              { label: "Support réactif", icon: "🛠️" },
            ].map((item) => (
              <div
                key={item.label}
        ...
        <section className="max-w-5xl mx-auto px-6 mb-20">
          ...
          <div className="space-y-3 max-w-3xl">
            ...
            <details className="glass rounded-2xl overflow-hidden group">
              ...
              <div className="px-5 pb-5 text-sm text-text-secondary leading-relaxed">
                Chez PACIFIK&apos;AI, un site vitrine est en ligne en 1 à 2 semaines. Un site e-commerce prend entre 2 et 4 semaines selon la complexité. Les landing pages sont généralement prêtes en quelques jours.
              </div>
            </details>
            <details className="glass rounded-2xl overflow-hidden group">
              <summary className="flex items-center justify-between p-5 cursor-pointer font-medium text-sm select-none hover:text-accent transition-colors duration-200 list-none">
        ...
        <section className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-text-secondary mb-8">
            ...
            internet. Devis personnalisé généralement sous 24h ouvrées — contact@pacifikai.com.
          </p>
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 px-8 py-4 bg-accent text-white rounded-xl font-medium text-lg hover:bg-accent/90 transition-colors"
